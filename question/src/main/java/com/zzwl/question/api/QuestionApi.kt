...
import com.zzwl.question.room.entity.common.CommentEntity
import com.zzwl.question.room.entity.common.FocusedCropsEntity
import com.zzwl.question.room.entity.common.MyQuestionEntity
import com.zzwl.question.room.entity.common.QuestionDetailEntity
import com.zzwl.question.room.entity.remote.ImageEntity
...
interface QuestionApi {
    ...
    @GET("get_comment")
    fun getComment(): Observable<BaseResult<List<CommentEntity?>?>>
    ...
    @GET("get_agr_info_list")
    fun getAgrInfoList(): Observable<BaseResult<List<MyQuestionEntity?>?>>
